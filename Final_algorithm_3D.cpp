                ...
                if (n_rab == 1) { // only one point in the lune
                    ...
                    if (n_rab == 2) {
                        ...
                        if (not eye_flag) {
                            ...
                            for (size_t j = 0; j < n_rab; ++j) {
                                points_loc.push_back(make_pair(
                                        Point(point_matrix[r_ab[j]][0], point_matrix[r_ab[j]][1], point_matrix[r_ab[j]][2]),
                                        j));
                            }
                            // Get the actual triangulation
                            ...
                            // We'll just use the current graph code that we have for this
                            {
                                ...
                                for (auto edge_2: possible_edges_loc) {
                                    ...
                                    double r_r = l2_dist(point_matrix[r_ab[edge_2.first]],
                                                         point_matrix[r_ab[edge_2.second]]);
                                    if (r_r < r) {
